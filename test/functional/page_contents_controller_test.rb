...
class PageContentsControllerTest < ActionController::TestCase
  ...
  test "should create page_content" do
    assert_difference('PageContent.count') do
      post :create, page_content: { content: @page_content.content, image_id: @page_content.image_id, index: @page_content.index, title: @page_content.title }
    end
  ...
  test "should update page_content" do
    put :update, id: @page_content, page_content: { content: @page_content.content, image_id: @page_content.image_id, index: @page_content.index, title: @page_content.title }
    assert_redirected_to page_content_path(assigns(:page_content))
  end
